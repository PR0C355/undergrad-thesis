...
Charades-Ego \cite{charadesego}, as well as it's predecessor Charades \cite{charades}, and ActivityNet-QA \cite{activitynetqa}, require
...
\begin{itemize}
  ...
  \item Molmo \cite{molmo}: A family of open vision-language models developed by the Allen Institute for AI. The more recent member of the family, Molmo 2 \cite{molmo2} image understanding, introducing spatio-temporal grounding capabilities and video tracking.
\end{itemize}
